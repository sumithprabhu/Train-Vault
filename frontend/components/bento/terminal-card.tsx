...
const LOG_LINES = [
  "> corpus.datasets.prepare()",
  "> debitPerMonthWei: 1000000000000000",
  "> corpus.datasets.upload(file, { name: 'train' })",
  "> Uploading to Synapse...",
  "> Piece CID: baga6ea4...",
  "> Treasury recordAndDeduct OK",
  "> Dataset saved to Filecoin",
  "> corpus.datasets.list()",
  "> 3 datasets, 1 named 'train'",
  "> --------- UPLOAD COMPLETE ---------",
]
